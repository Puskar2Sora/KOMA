...
const ProfileDashboard = ({ user }) => {
  ...
  return (
    <div className="bento-card p-6 md:p-8 flex flex-col md:flex-row gap-8 items-start relative bg-white">
      ...
      <div className="absolute top-0 right-0 w-full h-32 bg-gradient-to-br from-blue-50 to-gray-50 rounded-t-3xl border-b border-gray-100" />
      ...
      <div className="flex-1 w-full z-10 text-center md:text-left md:mt-12">
        <div className="flex flex-col md:flex-row md:items-center gap-3 mb-5">
          ...
          <span className="flex items-center gap-1.5 justify-center bg-blue-50 text-blue-700 text-xs font-bold px-3 py-1.5 rounded-full border border-blue-100 shadow-sm w-fit mx-auto md:mx-0">
